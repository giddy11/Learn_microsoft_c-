...
// TODO: Using the "ref" keyword arguments can be passed by reference which
// allows the functions to modify them
TestFunc2(ref val1);
//Console.WriteLine($"{val1}");

// TODO: The "out" keyword can be used to indicate that an argument is
// intended to return a value and is not an input
int sum, product;
